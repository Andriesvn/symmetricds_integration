...
To Setup a Full Server to Server Bidirectional Replication (NO Sub Filtering yet), you can excecute the SQL statement found under the symmetricds_integration/symmetric_server/samples/insert_sample.sql inside your Master server`s Site Database while Symmerticds is NOT running.
