...
doctype = 'Registration Redirect'
table_name = 'sym_registration_redirect'
name_field = 'registrant_external_id'
primary_keys = ['registrant_external_id']
has_creation = False
has_modified = False
has_modified_by = False

class RegistrationRedirect(Document):
