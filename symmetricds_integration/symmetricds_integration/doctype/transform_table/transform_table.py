...
doctype = 'Transform Table'
table_name = 'sym_transform_table'
name_field = 'transform_id'
primary_keys = ['transform_id','source_node_group_id','target_node_group_id']
has_creation = True
has_modified = True
has_modified_by = True

class TransformTable(Document):
