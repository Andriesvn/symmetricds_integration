...
doctype = 'Node Host Channel Stats'
table_name = 'sym_node_host_channel_stats'
name_field = 'node_id'
primary_keys = ['node_id','host_name','channel_id','start_time','end_time']
has_creation = False
has_modified = False
has_modified_by = False

class NodeHostChannelStats(Document):
