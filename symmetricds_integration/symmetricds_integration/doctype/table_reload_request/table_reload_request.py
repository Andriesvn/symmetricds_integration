...
doctype = 'Table Reload Request'
table_name = 'sym_table_reload_request'
name_field = 'source_node_id'
primary_keys = ['source_node_id','target_node_id','router_id','trigger_id']
has_creation = True
has_modified = True
has_modified_by = True

class TableReloadRequest(Document):
